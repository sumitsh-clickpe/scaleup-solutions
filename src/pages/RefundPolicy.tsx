    ...
    <div className="max-w-4xl mx-auto bg-card rounded-2xl p-8 md:p-16 border border-border/50 shadow-card">
      ...
      <div className="space-y-12 text-muted-foreground font-medium leading-relaxed text-lg">
        <p>
          ...
          is committed to protecting your information and privacy. This Refund Policy is designed to help you understand how we handle refunds and cancellations for our services.
        </p>
        ...
        <section>
          ...
          <p>You are advised to read this Refund Policy carefully. By accepting this Refund Policy and the Terms and Conditions of Use, a User expressly consents to <strong className="text-primary font-bold">"MargCred"</strong> collection, storage, use, and disclosure of his information as described herein.</p>
        </section>
        ...
        <section>
          ...
          <p>This Refund Policy applies to any information of the user when he accesses/visits our Sites or uses our Services and does not apply to online platforms or services that <strong className="text-primary font-bold">"MargCred"</strong> do not own or control.</p>
        </section>
        ...
        <section>
          ...
          <p>We may revise this Refund Policy from time to time to reflect changes to our business, the Sites or Services, or applicable laws. The revised Refund Policy will be effective as of the published effective date.</p>
        </section>
        ...
        <section>
          ...
          <p>For queries regarding this Refund Policy, contact <span className="text-foreground font-bold">+91 7965258132</span>.</p>
        </section>
      </div>
    </div>
  </main>
