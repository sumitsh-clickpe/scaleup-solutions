          ...
          {items.map(item => (
            <motion.div key={item.service.id} layout initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">${item.service.price}/mo</p>
              </div>
              <div className="flex items-center gap-3">
                ...
                <span className="font-display font-semibold min-w-[5rem] text-right">${item.service.price * item.quantity}</span>
